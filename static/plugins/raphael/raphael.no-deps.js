...
var __WEBPACK_AMD_DEFINE_ARRAY__, __WEBPACK_AMD_DEFINE_RESULT__;!(__WEBPACK_AMD_DEFINE_ARRAY__ = [__webpack_require__(/*! eve */ "eve")], __WEBPACK_AMD_DEFINE_RESULT__ = (function(eve) {
    ...
    var pathDimensions = R.pathBBox = function (path) {
        ...
        a2c = function (x1, y1, rx, ry, angle, large_arc_flag, sweep_flag, x2, y2, reArial, Helvetica, sans-serif) {
            ...
            if (!reArial, Helvetica, sans-serif) {
                xy = rotate(x1, y1, -rad);
                x1 = xy.x;
                y1 = xy.y;
                xy = rotate(x2, y2, -rad);
                ...
                f1 = reArial, Helvetica, sans-serif[0];
                f2 = reArial, Helvetica, sans-serif[1];
                cx = reArial, Helvetica, sans-serif[2];
                cy = reArial, Helvetica, sans-serif[3];
            }
            var df = f2 - f1;
            if (abs(df) > _120) {
                var f2old = f2,
